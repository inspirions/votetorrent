...
// ===========================================================================
// (f) COPY still holds exactly 155 keys (73 + the ten public.*/advisory.public.body
...
test('COPY holds exactly 155 keys, and three spot-checked untouched keys still hold their exact values', () => {
	assert.equal(Object.keys(COPY).length, 155);
